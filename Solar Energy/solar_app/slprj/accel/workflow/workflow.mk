...
MODEL              = workflow
MODULES            = rtGetInf.c rtGetNaN.c rt_nonfinite.c workflow_acc_data.c 
MAKEFILE           = workflow.mk
MATLAB_ROOT        = C:/Program Files/MATLAB/MATLAB Production Server/R2015a
ALT_MATLAB_ROOT    = C:/PROGRA~1/MATLAB/MATLAB~1/R2015a
MASTER_ANCHOR_DIR  = 
START_DIR          = M:/Solar Energy/solar_app
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/accel/workflow \
	-I$(START_DIR) \
